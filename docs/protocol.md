        # Dta70: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/dta70.git

        ## Objective

        DTA70 is a diagnostic test accuracy meta-analysis tool supporting 70 accuracy metrics with bivariate and hierarchical SROC modelling.
        ...
        - Code: https://github.com/mahmood726-cyber/dta70.git
        - Dashboard: https://mahmood726-cyber.github.io/dta70/
